...
RSpec.describe "Articles", type: :request do
  describe "GET /articles" do
    ...
    context "公開済みの記事がある時" do
      let!(:article1) { create(:article, :published_status, updated_at: 1.day.ago) }
      let!(:article2) { create(:article, :published_status, updated_at: 2.days.ago) }
      let!(:article3) { create(:article, :published_status) }
